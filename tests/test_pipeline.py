...
def test_chat_api_returns_day1_acceptance_shape():
    ...
    assert trace_stages == ["router", "planner", "executor", "synthesizer", "grounding_checker", "evaluation", "evidence"]
...
def test_troubleshooting_pipeline_executes_tools_and_trace():
    ...
    assert trace_stages == ["router", "planner", "executor", "synthesizer", "grounding_checker"]
