...
class Tracer:
    ...
    def end_stage(
        ...
        self._steps.append(TraceStep(
            ...
            precision_at_k=(rag_metadata or {}).get("precision_at_k"),
            recall_at_k=(rag_metadata or {}).get("recall_at_k"),
            rag_source_coverage=(rag_metadata or {}).get("source_coverage"),
            rag_missing_source_count=(rag_metadata or {}).get("missing_source_count"),
            grounded_answer_rate=(rag_metadata or {}).get("grounded_answer_rate"),
            rerank_applied=(rag_metadata or {}).get("rerank_applied"),
            dedup_count=(rag_metadata or {}).get("dedup_count"),
