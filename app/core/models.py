...
class TraceStep(BaseModel):
    ...
    blocked: bool = Field(default=False, description="Safety guard 是否拦截当前阶段")
    blocked_reason: str = Field(default="", description="Safety guard 拦截原因")
    input_summary: str = Field(default="", description="Safety guard 脱敏输入摘要")
